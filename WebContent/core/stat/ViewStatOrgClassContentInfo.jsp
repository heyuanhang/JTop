			...
			<table width="99.9%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						...
						当前位置：
						<a href="#">数据分析</a> &raquo; <a href="#">工作量统计</a> &raquo; <a href="#">按部门统计</a>
					</td>
					<td align="right">
						...
						<tr>
							<td style="padding: 7px 10px;">
								...
								<div>
									...
									<a href="<cms:BasePath/>stat/report.do?flag=org&ids=${param.ids}&sd=${param.sd}&ed=${param.ed}" class="btnwithico"><img src="../style/icons/report-excel.png" width="16" height="16" /><b>导出报表&nbsp;</b> </a>
							...
							<td id="uid_td25" style="padding: 2px 6px;">
								<div class="DataGrid">
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:QueryData objName="ST" service="cn.com.mjsoft.cms.stat.service.StatService" method="queryOrgContentTraceForTag" var="${param.ids},${param.sd},${param.ed}">
								
											<tr>
												<td>
												<cms:if test="${ST.orgName != '合计'}">
													&nbsp;${status.count}
												</cms:if>
													
												</td>
												<td>
													<cms:SystemOrg orgId="${ST.orgId}">
														${Org.uiName}
													</cms:SystemOrg>
												</td>
												<td>
