...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
			...
			<title>查阅${DataModel.modelName}工作流内容镜像</title>
					...
					<td class="mainbody" align="left" valign="top">
						<!--main start-->
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table-big-content" style="padding-top: 8px;">
								...
								<tr>
									<td id="main-td" class="input-title">
								...
								<tr>
									...
									<td class="td-input listdate-show-data">
										...
										<input id="creator" name="creator" readonly value="${SysUser.userTrueName}" type="text" class="form-input"  style="width: 252px;" maxlength="58" />
										</cms:SystemUser>
										  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
