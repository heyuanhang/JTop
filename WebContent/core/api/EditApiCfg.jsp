						...
						<cms:QueryData service="cn.com.mjsoft.cms.appbiz.service.AppbizService" method="getSysApiCfgForTag" objName="ApiCfg" var="${param.id},,,,">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								<tr>
									...
									<td  class="td-input">
										<input type="text" style="width:285px" id="apiName" name="apiName" class="form-input" value="${ApiCfg.apiName}"></input>
								...
								<tr>
									...
									<td class="td-input">
										<input type="text" style="width:285px" id="flowPath" name="flowPath" class="form-input" value="${ApiCfg.flowPath}"></input>
								...
								<tr>
									...
									<td class="td-input">
										<textarea id="extBehaviorClass" name="extBehaviorClass" style="width:285px; height:60px;" class="form-textarea">${ApiCfg.extBehaviorClass}</textarea>
									</td>
								</tr>
...
initRadio("mustTok","${ApiCfg.mustTok}");
initRadio("mustEnc","${ApiCfg.mustEnc}");
initRadio("mustSecTok","${ApiCfg.mustSecTok}");
initRadio("reqMethod","${ApiCfg.reqMethod}");
...
function submitSecForm()
{
	...
	if('${ApiCfg.flowPath}' != $('#flowPath').val() )
	{
	...
	var url = "<cms:BasePath/>appbiz/editApiCfg.do"+"?<cms:Token mode='param'/>";
