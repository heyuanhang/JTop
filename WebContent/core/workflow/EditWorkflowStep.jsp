...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<cms:LoginUser>
				<cms:SystemWorkflowStep flowId="${param.flowId}" step="${param.stepId}">
							...
							<td align="left" valign="top">
								...
								<div class="auntion_tagRoom_Content">
											...
											<li>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
													<tr>
														...
														<td width="80%" class="td-input">
															<cms:if test="${Step.isStart == 1}">
																<input type="text" readonly style="width:369px" id="stepNodeName" name="stepNodeName" class="form-input" value="${Step.stepNodeName}"></input>
															</cms:if>
															<cms:else>
																<input type="text" style="width:369px" id="stepNodeName" name="stepNodeName" class="form-input" value="${Step.stepNodeName}"></input>
															</cms:else>
													...
													<tr>
														...
														<td class="td-input">
															<cms:if test="${Step.isStart == 1}">
																<textarea readonly id="stepDesc" name="stepDesc" style="height:65px;width:370px" class="form-textarea">${Step.stepDesc}</textarea>
															</cms:if>
															<cms:else>
																<textarea id="stepDesc" name="stepDesc" style="height:65px;width:370px" class="form-textarea">${Step.stepDesc}</textarea>
															</cms:else>
													...
													<%--<tr>
														...
														<td class="td-input">
															<input name="conjunctOrgFlag" type="radio" value="0" />
															否&nbsp;
														...
														<script>
									    	initRadio('conjunctOrgFlag','${Step.conjunctOrgFlag}');								    
									    	</script>
													</tr>
													...
													<tr>
														...
														<td class="td-input">
															<input name="conjunctRoleFlag" type="radio" value="0" />
															否&nbsp;
														...
														<script>
									    	initRadio('conjunctRoleFlag','${Step.conjunctRoleFlag}');								    
									    	</script>
													</tr>
													...
													<tr>
														...
														<td class="td-input">
															<input name="conjunctManFlag" type="radio" value="0" />
															否&nbsp;
														...
														<script>
									    	initRadio('conjunctManFlag','${Step.conjunctManFlag}');								    
									    	</script>
													</tr>
													...
													--%><tr>
														...
														<td class="td-input">
															<input name="avoidFlag" type="radio" value="0" />
															否&nbsp;
													...
													<tr>
														...
														<script>
												    	initRadio('avoidFlag','${Step.avoidFlag}');	
												    	initRadio('orgMode','${Step.orgMode}');									    
												    	</script>
													</tr>
													...
													<table width="100%" border="0" cellpadding="0" cellspacing="0">
														<tr class="btnbg100">
															<div style="float:right">
																<a href="javascript:submitFlowStepForm();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16"><b>确认&nbsp;</b> </a>
										...
										<ul>
											<li>
												...
												<script type="text/javascript">
												 <cms:SystemWorkflowStepActor flowId="${param.flowId}" stepId="${param.stepId}" type="3">
												  var target = document.getElementById('checkedOrgId-${Actor.auditManId}');
												  if(target != null)
												  {
												  	target.checked=true;
												  }
											     </cms:SystemWorkflowStepActor>								
											</script>
									...
									<div id="g3_two_3" class="auntion_Room_C_imglist" style="display:none;">
										...
										<script type="text/javascript">
															 <cms:SystemWorkflowStepActor flowId="${param.flowId}" stepId="${param.stepId}" type="1">
															  var target = document.getElementById('checkedRoleId-${Actor.auditManId}');
															  if(target != null)
															  {
															  	target.checked=true;
															  }
													...
													<table class="listtable" width="100%" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td id="uid_td25" style="padding: 2px 6px;">
																...
																<script type="text/javascript">
									 							<cms:SystemWorkflowStepActor flowId="${param.flowId}" stepId="${param.stepId}" type="2">
									 							//alert('${Actor.auditManId}');
									 							var user = document.getElementById('checkedUserId-${Actor.auditManId}');
									 							if(user != null)
									 							{
									      							document.getElementById('checkedUserId-${Actor.auditManId}').checked=true;
									      						}
								     							</cms:SystemWorkflowStepActor>								
															</script>
															</td>
...
function submitFlowStepForm()
{
	...
	else
	{
	    ...
	    from.action="<cms:BasePath/>workflow/editWorkflowStep.do";
