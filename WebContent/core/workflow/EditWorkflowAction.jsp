...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>  
         ...
         {     	 	
            W.$.dialog.tips('编辑工作流动作成功',2,'32X32/succ.png'); 
            api.close(); 
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top">
					...
					<cms:SystemWorkflowAction actId="${param.actionId}">
						<form id="flowActionForm" name="flowActionForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								<tr>
									...
									<td  class="td-input">
										<input id="passActionName" name="passActionName" type="text" class="form-input" style="width:374px" value="${Action.passActionName}" />
								...
								<tr>
									...
									<td class="td-input">
										<textarea id="actDesc" name="actDesc" class="form-textarea" style="width:375px; height:60px;">${Action.actDesc}</textarea>
								</tr>
								...
								<tr>
									...
									<script>
									    	initRadio('conjunctManFlag','${Action.conjunctManFlag}');								    
									    	</script>
								</tr>
								...
								<tr>
									...
									<script>
									    	initRadio('orgBossMode','${Action.orgBossMode}');								    
									</script>
								</tr>
								<%--
								<tr>
									...
									<script>
									    	initRadio('recallMode','${Action.recallMode}');								    
									</script>
								</tr>
								...
								<tr>
									...
									<td class="td-input">
										...
										是&nbsp;
										<span class="ps">是否需要指定参与机构必须全部通过此动作才审核生效</span>
									</td>
									<script>
									    	initRadio('conjunctOrgFlag','${Action.conjunctOrgFlag}');								    
									    	</script>
								</tr>
								...
								<tr>
									...
									<td class="td-input">
										...
										是&nbsp;
										<span class="ps">是否需要指定参与角色必须全部通过此动作才审核生效</span>
									</td>
									<script>
									    	initRadio('conjunctRoleFlag','${Action.conjunctRoleFlag}');								    
									    	</script>
								</tr>
								...
								<%--<tr>
									...
									<td class="td-input">
										<input type="radio" name="needRequest" value="0" />
										否
							...
							<input type="hidden" id="actionId" name="actionId" value="${param.actionId}" />
						...
						<script>  
						initSelect('fromStepId','${Action.fromStepId}');
						initSelect('toStepId','${Action.toStepId}');
						initRadio('directMode','${Action.directMode}');
						initRadio('needRequest','${Action.needRequest}');
						
						cuac['${Action.fromStepId}-${Action.toStepId}'] = 'false';//已存在的不需要
					</script>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a href="javascript:submitFlowActionForm();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
function submitFlowActionForm()
{
    ...
    form.action="<cms:BasePath/>workflow/editWorkflowAction.do";
