										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
											<tr>
												...
												<td width="80%" class="td-input">
													<select style="width:127px"  id="htmlElementId" name="htmlElementId" onchange="javascript:switchHtmlElementType(this.value)">
														...
														<cms:if test="${param.modelType != 5 && param.modelType != 6 && param.modelType != 8 && param.modelType != 9   && param.modelType != 7 && param.modelType != 3}">
											...
											<tr id="mustFillDIV">
												...
												<td class="td-input">
													...
													&nbsp;&nbsp;&nbsp;<strong>搜索</strong><input type="checkbox" class="form-checkbox" id="searchFlag" name="searchFlag" value="1" disabled />
									...
									<li>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
											...
											<tr>
												...
												<td class="td-input">
													<input type="text" style="width:430px" id="cssClass" name="cssClass" class="form-input" value="${ModelFiled.cssClass}"></input>
												</td>
											</tr>
											...
											<tr>
												...
												<td width="75%" class="td-input">
													<textarea id="style" name="style" style="width:430px; height:90px;" class="form-textarea">${ModelFiled.style}</textarea>
												</td>
											</tr>
											...
											<tr>
												...
												<td class="td-input">
													<textarea id="javascript" name="javascript" style="width:430px; height:90px;" class="form-textarea">${ModelFiled.javascript}</textarea>
												</td>
											</tr>
...
initRadio('searchFlag','${ModelFiled.searchFlag}');
initRadio('pickFlag','${ModelFiled.pickFlag}');
 
if( eId == '10' || eId == '11' || eId == '12' || eId == '13' || eId == '14' )
{
	$('#searchFlag').attr("disabled",true); 
	$("#searchFlag").attr('checked',false);
}
else if( eId == '3')
{
	$('#searchFlag').attr("disabled",false); 
}
