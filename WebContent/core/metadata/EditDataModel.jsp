						...
						<form id="modelForm" name="modelForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								...
								<tr>
									...
									<td class="td-input">
										<input type="radio" name="simpleMode"  value="0"  />
										是
										<input type="radio" name="simpleMode" value="1"  checked/>
										否
										<span class="ps">简易操作不含复制,关联,共享,外链,内容关联等按钮</span>
									</td>
								</tr>
...
initRadio('simpleMode','${DataModel.simpleMode}');
