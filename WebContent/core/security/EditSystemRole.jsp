						...
						<form id="roleForm" name="roleForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								...
								<tr>
									...
									<td class="td-input">
										<select id="orgId" name="orgId" class="form-select" disabled style="width:264px">
											<option value="-1">
												------------- 请选择所属部门 -------------
											</option>
							...
							<input type="hidden" id="orgId" name="orgId" value="${Role.orgId}" />
...
function submitRoleForm()
{
   var hasError = false;
    ...
    currError = submitValidate('orgId',1,null,null);
