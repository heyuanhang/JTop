						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td width="80%" class="td-input">
									<select disabled id="parentId" name="parentId" class="form-select" style="width:318px">
										<option value="-1">
											--------------- 请选择上级部门 ---------------
										</option>
							...
							<cms:SystemOrg orgId="${param.orgId}">
							...
							<tr>
								...
								<td width="80%" class="td-input">
									<input id="orgName" name="orgName" type="text" class="form-input" style="width:314px" value="${Org.orgName}"/>
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="td-input">
									<input disabled id="orgFlag" name="orgFlag" type="text" class="form-input" style="width:314px" value="${Org.orgFlag}"/>
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="orgDesc" name="orgDesc" class="form-textarea" style="width:313px; height:60px;">${Org.orgDesc}</textarea>
							</tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" >
						<tr class="btnbg100">
							<div style="float:right">
								<a href="javascript:submitOrgForm();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
initSelect('parentId','${Org.parentId}');
...
function submitOrgForm()
{
   ...
   orgForm.action="<cms:BasePath/>organization/editOrg.do";
   orgForm.submit();
}
