							...
							<tr>
								<td style="padding: 7px 10px;" class="">
									...
									<select class="form-select" id="resTag" onchange="javascript:change(this.value)"  >
										<option value="">
											...
											<cms:QueryData objName="Tag"
												...
												method="getResTagForTag" var="music">
									...
									<div>
										...
										<a href="javascript:openAddWxMusicDialog();" class="btnwithico"> <img src="../../core/style/icons/music--plus.png" alt="" /><b>添加音乐&nbsp;</b> </a>
								...
								<td id="uid_td25" style="padding: 2px 6px;">
									<div class="DataGrid">
										...
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:QueryData objName="WR" service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getWxResForTag"  var=",music,${param.resTag},${param.pn},12">
												<cms:ResInfo res="${WR.musicRes}">
													...
													<tr>
														...
														<div style="height:4px;"></div>
																...
																<cms:if test="${empty WR.musicThumb}">
																...
																<cms:else>
																		...
																		<a class="cmsSysShowSingleImage" href="${ThRes.url}"><img id="contentImageShow" src="${ThRes.url}" width="100" height="67" />
																		</a>
														...
														<td>
															<div align="center">
																...
																<a href="javascript:openEditWxMusicDialog('${WR.wrId}')"><img
...
function openAddWxMusicDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/AddWxMusicRes.jsp?dialogApiId=oawid'
	});
}

function openEditWxMusicDialog(id)
{
	$.dialog({ 
		id: 'oewid',
    	title :'编辑音乐素材',
        ...
        content: 'url:<cms:Domain/>core/weixin/EditWxMusicRes.jsp?dialogApiId=oewid&id='+id
	});
}
...
function openManageResTagDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/dialog/ManageResTag.jsp?dialogApiId=omrtd&type=music'
	});
}
...
function deleteWxSRes(id)
{
	...
	$.dialog({ 
                    ...
                    var url = "<cms:BasePath/>wx/deleteWxMusic.do?ids="+id+"&<cms:Token mode='param'/>";
...
function transferWxRes()
{
	...
	$.dialog({ 
                    ...
                    var url = "<cms:BasePath/>wx/transferRes.do?type=thumb&ids="+ids+"&<cms:Token mode='param'/>";
