	 ...
	 var checkInfoId = $('input:radio[name=checkInfo]:checked').val();
	  ...
	  if('undefined' != typeof(checkInfoId))
	  {
		 if('${param.apiId}' == '')
		 {
			...
			W.document.getElementById('msgTitle').value = '[音乐'+checkInfoId+'] '+$('#ti-'+checkInfoId).val();
		 }
		 else
		 {
			...
			api.get('${param.apiId}').document.getElementById('msgTitle').value = '[音乐'+checkInfoId+'] '+$('#ti-'+checkInfoId).val();
		 }
