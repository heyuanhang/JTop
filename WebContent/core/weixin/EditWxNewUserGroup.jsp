...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	<cms:QueryData service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getWxUserGroupForTag" objName="UG" var="${param.gid}">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								  ...
								  <tr>
											<td width="27%" class="input-title">
												...
												<td class="td-input">
												 		<input type="text" size="35" id="gname" name="gname"  class="form-input" value="${UG.wuGroupName}"></input>
...
function submitForm()
{
    ...
    var url = "<cms:BasePath/>wx/editWxUserGroupFromWxServer.do"+"?<cms:Token mode='param'/>";
