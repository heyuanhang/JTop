							...
							<tr>
								<td style="padding: 7px 10px;" class="">
									...
									<select class="form-select" id="resTag" onchange="javascript:change(this.value)"  >
										<option value="">
											...
											<cms:QueryData objName="Tag"
												...
												method="getResTagForTag" var="voice">
									...
									<div>
										...
										<a href="javascript:openAddWxVoiceDialog();" class="btnwithico"> <img src="../../core/style/icons/socket--plus.png" alt="" /><b>添加语音&nbsp;</b> </a>
								...
								<td id="uid_td25" style="padding: 2px 6px;">
									<div class="DataGrid">
										...
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:QueryData objName="WR" service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getWxResForTag"  var=",voice,${param.resTag},${param.pn},12">
...
function openAddWxVoiceDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/AddWxVoiceRes.jsp?dialogApiId=oawid'
	});
}
...
function openEditWxImageDialog(id)
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/EditWxVoiceRes.jsp?dialogApiId=oewid&id='+id
	});
}
...
function openManageResTagDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/dialog/ManageResTag.jsp?dialogApiId=omrtd&type=voice'
	});
}
...
function deleteWxSRes(id)
{
	...
	$.dialog({ 
                    ...
                    var url = "<cms:BasePath/>wx/deleteWxVoice.do?ids="+id+"&<cms:Token mode='param'/>";
...
function transferWxRes()
{
	...
	$.dialog({ 
                    ...
                    var url = "<cms:BasePath/>wx/transferRes.do?type=voice&ids="+ids+"&<cms:Token mode='param'/>";
...
function openAddToSendContentDialog()
{
	...
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/SendAllWxInfo.jsp?msgId='+ids+'&msgType=voice'
	});
}
