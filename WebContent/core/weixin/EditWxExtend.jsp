			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left" valign="top">
						...
						<cms:QueryData service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getWxExtendForTag" objName="WB" var="${param.ebId},,">
						...
						<form id="exForm" name="exForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								<tr>
									...
									<td width="80%" class="td-input">
										<input type="text" style="width:325px"  id="ebName" name="ebName" value="${WB.ebName}" class="form-input"></input>
								...
								<tr>
									...
									<td class="td-input">
										<textarea id="beClass" name="beClass" style="width:325px; height:60px;" class="form-textarea">${WB.beClass}</textarea>
									</td>
								</tr>
								
								<cms:if test="${WB.isMenu == 0}">
									<tr>
													<td class="input-title">
														<strong>接口状态 
													</td>
													<td class="td-input">
														<input name="useStatus" type="radio" value="1" class="form-radio" />启用&nbsp;&nbsp;&nbsp;
														<input name="useStatus" type="radio" value="0" class="form-radio"/>停用
													</td>
									</tr>
								</cms:if>
								<cms:else>								
									<input type="hidden" name="useStatus" value="1" />
								</cms:else>
							...
							<!-- hidden -->
						 	<input type="hidden" id="ebId" name="ebId" value="${param.ebId}" />
						</form>
...
initSelect('eventType', '${WB.eventType}');

initRadio('useStatus', '${WB.useStatus}');
...
function submitForm()
{
    ...
    var url = "<cms:BasePath/>wx/editWxExtend.do"+"?<cms:Token mode='param'/>";
