                          ...
                          <input id="wx_sp_file_sys_jtopcms_media_cover_src" name="wx_sp_file_sys_jtopcms_media_cover_src" type="hidden" value="${Site.siteImagePrefixUrl}${SysRes.cover}"/>
							...
							<tr>
								<td  class="input-title">
									...
									<td width="80%" class="td-input">
										<input type="text" style="width:385px;" id="musicUrl" name="musicUrl" class="form-input" value="${WR.musicUrl}"></input>
							...
							<tr>
								<td  class="input-title">
									...
									<td width="80%" class="td-input">
										<input type="text" style="width:385px;" id="hqMusicUrl" name="hqMusicUrl" class="form-input" value="${WR.hqMusicUrl}"></input>
...
function submitForm()
{
	...
	form.action = '<cms:BasePath/>wx/editWxMusic.do';
