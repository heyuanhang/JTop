...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript" src="js/handlerSingleMedia.js"></script>
		...
		utype = '${param.type}';
         ...
         var upt = "*.avi;*.mpg;*.mpeg;*.mp4";
         
         var upl = "20 MB";
         
         if('${param.type}' == 'voice')
         {
         	upt = "*.mp3;*.wma;*.gif;*.wav;*.amr";
									...
									<li>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
											...
											<tr id="serverTr">
												...
												<td class="td-input">
													<textarea readonly id="fileInfo" name="fileInfo" style="height:60px;width:271px" class="form-textarea"></textarea>
											...
											<tr>
												...
												<td class="td-input">
													<input type="text" style="width:271px" id="posName" name="posName" value="" class="form-input"></input>
												</td>
											</tr>
 	...
 	$.ajax({
        ...
        {        
        	...
        	else
        	{
				 ...
				 W.document.getElementById(fieldSign+'_sys_jtopcms_iframe').src = '<cms:BasePath/>core/content/UploadVideoModule.jsp?fileUrl='+fileUrl+'&autoStart=true';
				 
				//用于显示
				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_showtime').value = jsonObj.obj_0.duration;
				 ...
				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_width').value = w;
				 
				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_height').value = h;
				 
				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_name').value = jsonObj.obj_0.resName;

				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_type').value = jsonObj.obj_0.fileType;
				 
				 //每次上传新的视频需要将以前截取的图片信息置空
				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_cover_src').value = '';
				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_cover_w').value = '';
				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_cover_h').value = '';
				 W.document.getElementById(fieldSign+'_sys_jtopcms_media_cover_n').value = '';
				 
				 //用于cms处理
				 W.document.getElementById(fieldSign).value = jsonObj.obj_0.resId;
				 
				 W.document.getElementById(fieldSign+'_delete_flag').value = 'false';
