									...
									<li>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
											...
											<tr id="serverTr">
												...
												<td class="td-input">
													<textarea readonly id="fileInfo" name="fileInfo" style="word-wrap:normal;height:80px;width:270px" class="form-textarea"></textarea>
											...
											<tr>
												...
												<td class="td-input">
													<input type="text"  style="width:231px" id="titleName" name="titleName" class="form-input"></input>
												</td>
											</tr>
	...
	else if('web' == source)
	{
		...
		{				
		   ...
		   // }
		   	...
		   	api.get(apiId).ue.execCommand('insertHtml', "<div style='text-align: center'><img name='jtopcms_content_image' src='" + imageUrlArray[i] + "' alt='' height='"+newWH[1]+"' width='"+newWH[0]+"'/>&nbsp<br><br>"+name+"</div><br><br>")    
		}
