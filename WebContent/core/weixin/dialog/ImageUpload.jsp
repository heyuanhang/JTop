...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript" src="../../weixin/dialog/js/handlerEditorImage.js"></script>
		<style type="text/css">
		<!--
		* {
		    margin:0;
	...
	<body>
		<form id="advertPosForm" name="advertPosForm" method="post">
									...
									<li>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
											...
											<tr id="serverTr">
												...
												<td class="td-input">
													<textarea id="fileInfo" name="fileInfo" class="form-textarea" style="word-wrap:normal;height:80px;width:270px" readonly></textarea>
			...
			<input type="hidden" id="classId" value="-9999" />
...
function addNewImage()
{
	...
	else if('web' == source)
	{
		...
		//var oEditor = W.FCKeditorAPI.GetInstance("${param.editorId}");
				 		 ...
				 		 ({
							...
							{				
								...
								//if(oEditor.EditMode == W.FCK_EDITMODE_WYSIWYG)
						   		...
						   		api.get(apiId).ue.execCommand('insertHtml', data)      
				  			}
				  		 });	
