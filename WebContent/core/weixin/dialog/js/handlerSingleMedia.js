...
function fileQueued(file)
{
	...
	var classObj = W.document.getElementById("classId");
	...
	//addReadyFileInfo(file.id,file.name,"成功加载到上传队列");
	 ...
	 swfu.addPostParam("classId", W.document.getElementById("classId").value);
...
{	
	...
	{				
		 ...
		 if('voice' == utype)
		 {
		 	api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_iframe').src = basePath+'/core/weixin/UploadVideoModule.jsp?type=voice&fileUrl='+jsonObj.obj_0.fileUrl+'&autoStart=true';
		 	
		 }
		 else
		 {
		 	api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_iframe').src = basePath+'/core/weixin/UploadVideoModule.jsp?fileUrl='+jsonObj.obj_0.fileUrl+'&autoStart=true';
		 }
		//用于显示
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_showtime').value = jsonObj.obj_0.videoT;
		 
		 if('voice' != utype)
		 {
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_width').value = jsonObj.obj_0.videoW;
		 
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_height').value = jsonObj.obj_0.videoH;
		 }
		 
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_name').value = name;
		  
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_type').value = type;
		 
		 //每次上传新的视频需要将以前截取的图片信息置空
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_cover_src').value = '';
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_cover_w').value = '';
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_cover_h').value = '';
		 api.get(apiId).document.getElementById(mediaSrcId+'_sys_jtopcms_media_cover_n').value = '';
		 
		 //用于cms处理
		 api.get(apiId).document.getElementById(mediaValId).value = jsonObj.obj_0.resId;
		 
		  api.get(apiId).document.getElementById('resName').value = jsonObj.obj_0.resName;
		 //alert(api.get(apiId).document.getElementById(mediaSrcId+'_delete_flag'));
		 //api.get(apiId).document.getElementById(mediaSrcId+'_delete_flag').value = 'false';
