			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left" valign="top">
						...
						<cms:QueryData service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getWxMessageForTag" objName="WM" var="${param.id},,,">
						...
						<form id="exForm" name="exForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								<tr>
									...
									<td width="80%" class="td-input">
										<input type="text" size="52" id="inputKey" name="inputKey" value="${WM.inputKey}" class="form-input"></input>
								 ...
								 <tr>
												...
												<td class="td-input">
													...
													<cms:if test="${WM.infoId != -1}">
														<cms:QueryData objName="News" service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getNewsItemForTag"  var=",,,,${WM.infoId}">						
													 		...
													 		<input type="text" size="52" readonly id="msgTitle" name="msgTitle"  class="form-input" value="[图文${News.infoId}] ${News.title}"></input>
													...
													<cms:elseif  test="${WM.resId != -1}">
														...
														<cms:ResInfo res="${WR.imageRes}">
															...
															<input type="text" size="52" readonly id="msgTitle"  name="msgTitle" class="form-input" value="[${WR.resTypeStr}${WR.wrId}] ${WR.resTitle}"></input>
													...
													<cms:elseif  test="${WM.isText == 1}">
														...
														<input type="text" size="52" readonly id="msgTitle"  name="msgTitle" class="form-input" value="[内部文本消息]"></input>
								  ...
								  <tr>
												<td class="input-title">
													...
													<td class="td-input">
														<input name="isInclude" type="radio" value="0" class="form-radio" />全字&nbsp;
									 ...
									 <tr>
												<td class="input-title">
													...
													<td class="td-input">
														<input name="isText" type="radio" value="1" class="form-radio"/>文本&nbsp;
							...
							<!-- hidden -->
						 	<input type="hidden" id="msgId" name="msgId" value="${param.id}" />
						</form>
...
initRadio('isInclude','${WM.isInclude}');
   
initRadio('isText','${WM.isText}');
...
function submitForm()
{
    ...
    var url = "<cms:BasePath/>wx/editWxMsg.do"+"?<cms:Token mode='param'/>";
