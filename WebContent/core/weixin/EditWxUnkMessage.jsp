...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
<cms:QueryData service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getWxUnkMessageForTag" objName="WM" var="${param.msgType}">
				...
				<tr>
					<td align="left" valign="top">
						...
						<form id="exForm" name="exForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								<tr>
									...
									<td width="80%" class="td-input">
										<select disabled id="msgType" name="msgType" class="form-select"  style="width:347px">
												...
												<td class="td-input">
												 	<cms:if test="${WM.infoId != -1}">
														<cms:QueryData objName="News" service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getNewsItemForTag"  var=",,,,${WM.infoId}">						
													 		...
													 		<input type="text" style="width:342px" readonly id="msgTitle" name="msgTitle"  class="form-input" value="[图文${News.infoId}] ${News.title}"></input>
													...
													<cms:elseif  test="${WM.resId != -1}">
														...
														<cms:ResInfo res="${WR.imageRes}">
															...
															<input type="text" style="width:342px" readonly id="msgTitle"  name="msgTitle" class="form-input" value="[${WR.resTypeStr}${WR.wrId}] ${WR.resTitle}"></input>
													...
													<cms:elseif  test="${WM.isText == 1}">
														...
														<input type="text" style="width:342px" readonly id="msgTitle"  name="msgTitle" class="form-input" value="[内部文本消息]"></input>
							...
							<!-- hidden -->
							<input type="hidden" id="msgType" name="msgType"  class="form-input" value="${WM.msgType}"></input>
...
initSelect('msgType','${param.msgType}');
...
function submitForm()
{
    ...
    var url = "<cms:BasePath/>wx/editWxUnkMsg.do"+"?<cms:Token mode='param'/>";
