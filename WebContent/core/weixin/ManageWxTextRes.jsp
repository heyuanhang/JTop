							...
							<tr>
								<td style="padding: 7px 10px;" class="">
									...
									<select class="form-select" id="resTag" onchange="javascript:change(this.value)"  >
										<option value="">
											...
											<cms:QueryData objName="Tag"
												...
												method="getResTagForTag" var="text">
									...
									<div>
										...
										<a href="javascript:openAddWxTextDialog();" class="btnwithico"> <img src="../../core/style/icons/script--plus.png" alt="" /><b>添加文本&nbsp;</b> </a>
								...
								<td id="uid_td25" style="padding: 2px 6px;">
									<div class="DataGrid">
										...
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:QueryData objName="WR" service="cn.com.mjsoft.cms.weixin.service.WeixinService" method="getWxResForTag"  var=",text,${param.resTag},${param.pn},12">
													...
													<tr>
														...
														<td>
															<div align="center">
																...
																<a href="javascript:openEditWxTextDialog('${WR.wrId}')"><img
...
function openAddWxTextDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/AddWxTextRes.jsp?dialogApiId=oawid'
	});
}

function openEditWxTextDialog(id)
{
	$.dialog({ 
		id: 'oewid',
    	title :'编辑文本素材',
        ...
        content: 'url:<cms:Domain/>core/weixin/EditWxTextRes.jsp?dialogApiId=oewid&id='+id
	});
}
...
function openManageResTagDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/dialog/ManageResTag.jsp?dialogApiId=omrtd&type=text'
	});
}
...
function deleteWxSRes(id)
{
	...
	$.dialog({ 
                    ...
                    var url = "<cms:BasePath/>wx/deleteWxText.do?ids="+id+"&<cms:Token mode='param'/>";
...
function transferWxRes()
{
	...
	$.dialog({ 
                    ...
                    var url = "<cms:BasePath/>wx/transferRes.do?ids="+ids+"&<cms:Token mode='param'/>";
...
function openAddToSendContentDialog()
{
	...
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/weixin/SendAllWxInfo.jsp?msgId='+ids+'&msgType=text'
	});
}
