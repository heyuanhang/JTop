										...
										<cms:QueryData service="cn.com.mjsoft.cms.cluster.service.ClusterService" method="getClusterServerInfoForTag" var="" objName="Cs"  >
											...
											<tr>
												...
												<td>
													<div> 
														<center>
															<a href="javascript:transferData('${Cs.serverId}');"><img src="../../core/style/icons/document-page-next.png" width="16" height="16" />&nbsp;同步至集群服务器</a> &nbsp; &nbsp;
...
{
	var tip = $.dialog.tips('正在执行同步到集群节点...',9600000000,'loading.gif');

	var url = "<cms:BasePath/>site/transferSiteFile.do?id="+id+"&<cms:Token mode='param'/>";
 	var postData = '';
