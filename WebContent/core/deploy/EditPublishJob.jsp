...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	<cms:QueryData service="cn.com.mjsoft.cms.schedule.service.ScheduleService" method="getScheduleJobDetailTag" objName="Sch" var="${param.jobId}," >
					...
					<form id="jobForm" name="jobForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="jobDesc" name="jobDesc" class="form-textarea" style="width:360px; height:50px;">${Sch.jobDesc}</textarea>
							...
							<tr id="trSeg">
								...
								<td class="td-input">
									每隔
									<input type="text" id="periodVar" name="periodVar" size=3 value="${Sch.periodVar}" class="form-input" />
									<select id="periodSegment" name="periodSegment" class="form-select" style="width:62px;height:30px">
										<%--<option value="s">
											秒 &nbsp;&nbsp;&nbsp;
										</option>
										--%><option value="2" >
							...
							<tr id="trEvery" style="display:none">
								...
								<td class="td-input">
									每天在
									<input id="dayExeTime" name="dayExeTime" size="14" maxlength="30" type="text" class="form-input-time" onmousedown="javascript:WdatePicker({skin:'twoer',dateFmt:'HH:mm:ss'});" value="${Sch.dayExeTime}"/>
									执行一次
								</td>
							</tr>
							...
							<tr id="trCron" style="display:none">
								...
								<td class="td-input">
									Cron规则
									<input type="text" id="cronExpression" id="cronExpression" style="width:302px" value="" class="form-input" value="${Sch.cronExpression}"/>
									<a href="http://cron.qqe2.com/" target="_blank"><img class="from-img-icon" src="../style/blue/icon/help.png" /></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="td-input">
									...
									<input id="jobStartDate" name="jobStartDate" style="width:164px" maxlength="30" type="text" class="form-input-date" onmousedown="javascript:WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'});" value="${Sch.jobStartDate}"/>
									&nbsp;至 &nbsp;
									<input  id="jobEndDate" name="jobEndDate" style="width:164px" maxlength="30" type="text" class="form-input-date" onmousedown="javascript:WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'});" value="${Sch.jobEndDate}"/>
						...
						<!-- hidden -->
						<input type="hidden" id="jobId" name="jobId" value="${Sch.jobId}"/>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a href="javascript:submitJobForm();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
initRadio('homePubTarget','${Sch.homePage}');

initRadio('channelPubTarget','${Sch.channel}');

initRadio('specPubTarget','${Sch.spec}');


initRadio('triggerType','${Sch.triggerType}');

initSelect('periodSegment','${Sch.periodSegment}');

 if("2" == '${Sch.triggerType}')
   {
...
function submitJobForm()
{
	...
	jobForm.action = '<cms:BasePath/>job/editPSJob.do';
