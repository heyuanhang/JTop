...
<cms:Content id="${param.id}">
	...
	<script type="text/javascript" src="${ResBase}mob/js/common.js"></script>
	<script>
	...
	<body>
		<header class="mui-bar mui-text-center">
			...
			<h1 class="mui-title"><span class="logo">sncms - 内容评论</span></h1>
		</header>
		...
		<div class="mui-content">	
			...
			<div class="next-article-box mui-bg-white mt15">
				<div class="news-list-title">
					<span>评论</span>
					<cms:ContentStatus contentId="${Info.contentId}">
					<span class="mui-pull-right mui-h5">参与者${InfoStatus.commCount}人</span>
					</cms:ContentStatus>
				</div>
				<ul class="mui-table-view">
					...
					<li class="mui-table-view-cell mui-media">
						<a href="javascript:void();">
                                                  <img class="mui-media-object mui-pull-left img-circle" src="${ResBase}mob/img/def_avatar.png">
...
function commentContent()
{
  ...
  var url = '${SiteBase}comment/clientAddComment.do';
