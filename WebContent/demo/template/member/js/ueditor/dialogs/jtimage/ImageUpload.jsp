...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript" src="${ResBase}js/SWFUpload/handlerEditorImage.js"></script>
		<style type="text/css">
		<!--
		* {
		    margin:0;
		...
		basePath = '${SiteBase}';
         ...
         var swfu;
			...
			// Button Settings
			button_image_url : "${SiteBase}core/javascript/upload/SWFUpload/upload.png",
			...
			// Flash Settings
			flash_url : "${SiteBase}core/javascript/upload/SWFUpload/swfupload.swf",
								...
								<ul>
									<li>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
											<tr>
												...
												<td class="td-input">
													...
													<input type="hidden" size="4" id="maxWidth" class="form-input" value="500"></input>
													 
													<input type="hidden" size="4" id="maxHeight" class="form-input" value="600"></input>
													<input type="hidden" size="4" id="disposeMode" class="form-input" value="1"></input>
											...
											<tr id="serverTr">
												...
												<td class="td-input">
													<textarea id="fileInfo" name="fileInfo" class="form-textarea" style="word-wrap:normal;height:200px;width:270px" readonly></textarea>
										...
										<div id="divProcessing" style="width:200px;height:30px;position:absolute;left:190px;top:290px;display:none">
											<img style="vertical-align: middle;" src="${SiteBase}core/javascript/dialog/skins/icons/loading.gif" width=28 height=28 class="ui_icon_bg" />
											上传处理中......
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
												<tr class="btnbg100">
													<div style="float:right">
														<a id="buttonHref" href="javascript:addNewImage();"  class="btnwithico"><img src="${SiteBase}core/style/icons/tick.png" width="16" height="16"><b>确认&nbsp;</b> </a>
														<a href="javascript:close();"  class="btnwithico"><img src="${SiteBase}core/style/icon/close.png" width="16" height="16"><b>取消&nbsp;</b> </a>
													</div>
												</tr>
											</table>
										</div>
