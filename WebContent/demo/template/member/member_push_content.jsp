	...
	<body>
		<div class="header">
			...
			<script type="text/javascript"
				...
				<script type="text/javascript" src="${ResBase}member/js/editor_content_format.js"></script>

			<cms:Set
			val="'fullscreen','jtuploadimage', 'source', 'bold', 'italic', 'underline', 'fontborder', 'strikethrough','removeformat','forecolor', 'backcolor', 'formatmatch', 'autotypeset', 'link', 'unlink', 'anchor','fontfamily', 'fontsize','insertorderedlist', 'insertunorderedlist','undo', 'redo'"
			id="UE_SMP" />
