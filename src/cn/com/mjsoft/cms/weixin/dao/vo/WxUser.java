...
@Table( name = "wx_user", id = "", idMode = EntitySqlBridge.NO_KEY_ID )
public class WxUser
{
    ...
    private String wuSubscribe_time;
    private String wuGroupid;
    private String wuUnionid;
    private String wuTagid_list;
    ...
    public String getWuSubscribe_time()
    {
        return wuSubscribe_time;
    }

    public void setWuSubscribe_time( String wuSubscribe_time )
    {
        this.wuSubscribe_time = wuSubscribe_time;
    }

    public String getWuTagid_list()
    {
        return wuTagid_list;
    }

    public void setWuTagid_list( String wuTagid_list )
    {
        this.wuTagid_list = wuTagid_list;
    }
