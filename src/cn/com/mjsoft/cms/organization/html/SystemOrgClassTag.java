...
public class SystemOrgClassTag extends AbstractIteratorTag
{
    ...
    protected List returnObjectList()
    {
        ...
        return orgService.retrieveClassBeanByOrgId( originalOrgIdVar, orgIdVar,
            StringUtil.changeStringToList( secType, "," ), siteIdVar,
            isParRootOrg, isParentMode, StringUtil.getBooleanValue( specMode,
                false ) );
    }
