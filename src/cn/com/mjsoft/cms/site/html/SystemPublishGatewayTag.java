...
public class SystemPublishGatewayTag extends AbstractIteratorTag
{
    ...
    protected List returnObjectList()
    {
        ...
        if( !"".equals( id ) )
        {
            ...
            result.add( siteService
                .retrieveSinglePublishGatewayBeanById( Long.valueOf( StringUtil
        ...
        {
            return siteService.retrievePublishGatewayBeanBySiteFlag( site
                .getSiteId() );
        }
    }
