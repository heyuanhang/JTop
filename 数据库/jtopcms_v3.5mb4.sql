...
CREATE TABLE `content_main_info`  (
  ...
  `appearStartDateTime` datetime NULL,
  `appearEndDateTime` datetime NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 10786 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
